...
class BrightnessControlGUI:
    def __init__(self):
        ...
        # Create main window
        self.root = tk.Tk()
        self.root.title("*** ENHANCED INTERFACE v2.0 *** - Auto Brightness & Monitor Control")
    ...
    def setup_ui(self):
        ...
        # Force theme application to this frame
        style = ttk.Style()
        style.configure('Main.TFrame', background=plasma_theme.colors['window_bg'])
        ...
        toggle_frame.configure(style='Main.TFrame')
